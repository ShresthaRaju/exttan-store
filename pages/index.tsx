...
const Home: NextPage = () => {
  ...
  const { products, fetchProducts, cart, showCart, viewCart } = useAppStore()
      ...
      <main className='py-8 px-10 xl:px-16'>
        ...
        <div className="flex items-center justify-between mt-5">
          ...
          <div className="relative">
            <button type='button' className='py-1.5 px-3 flex items-center space-x-1 rounded-md text-sm bg-blue-600 text-gray-200 hover:ring-1 hover:ring-blue-600' onClick={viewCart}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clipRule="evenodd" />
              </svg>
              <span>My Cart</span>
            </button>
            <span className="absolute -right-2 -top-2 bg-amber-400 rounded-full text-xs px-1.5 py-0.5 font-semibold animate-bounce">{cart?.length}</span>
          </div>
        </div>
